    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <p className="auth-subtitle">
          Your personal, broadcaster-quality F1 dashboard.
          <br />
          Sign in to access live standings, race countdowns & paddock intel.
        </p>
